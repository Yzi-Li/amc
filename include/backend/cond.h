...
typedef int (*backend_cond_elif_f)(backend_cond_if_handle *handle);
typedef int (*backend_cond_else_f)(backend_cond_if_handle *handle);
typedef int (*backend_cond_if_f)(backend_cond_if_handle *handle);
typedef backend_cond_if_handle *(*backend_cond_if_begin_f)(void);
typedef int (*backend_cond_if_cond_f)(backend_cond_if_handle *handle);
